...
const file_orders_proto_rawDesc = "" +
	...
	"\fOrderService\x128\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\x120\n" +
	"\tGetOrders\x12\x10.GetOrderRequest\x1a\x11.GetOrderResponseB2Z0github.com/uchidas-rogue/grpc-test/common/ordersb\x06proto3"
